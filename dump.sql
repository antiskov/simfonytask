...
INSERT INTO `doctrine_migration_versions` VALUES ('DoctrineMigrations\\Version20241119161426','2024-11-19 16:14:33',30);
...
CREATE TABLE `user` (
  ...
  UNIQUE KEY `UNIQ_8D93D649CE70D424` (`pass`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES ('100','login','admin','911','[\"ROLE_TEST_ADMIN\"]'),('47','te5tUse6','passe','423428','[\"ROLE_TEST_USER\"]');
...
-- Dump completed on 2024-11-19 16:18:53
